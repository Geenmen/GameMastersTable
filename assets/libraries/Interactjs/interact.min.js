/* interact.js 1.10.11 | https://interactjs.io/license */ ! function (t) {
    ...
    function E(t, e) {
        for (var n, r = [], o = t;
            (n = S(o)) && o !== e && n !== o.ownerDocument;) r.unshift(o), o = n;
        return r
    }
    ...
    Object.defineProperty(R, "__esModule", {
        ...
        if (i.default.object(e) && (n = e, e = ""), i.default.func(n)) r[e] = r[e] || [], r[e].push(n);
    ...
    function bt(t) {
        ...
        if ("gesture" === e.prepared.name) {
            ...
            if (n.touches = [o[0], o[1]], a) n.distance = B.touchDistance(o, l), n.box = B.touchBBox(o), n.scale = 1, n.ds = 0, n.angle = B.touchAngle(o, l), n.da = 0, e.gesture.startDistance = n.distance, e.gesture.startAngle = n.angle;
            else if (s) {
                var u = e.prevEvent;
    ...
    var kt, It, Dt = 0,
        At = {
            ...
            init: function (t) {
                if (kt = t.requestAnimationFrame, It = t.cancelAnimationFrame, !kt)
        ...
        onInteractionMove: function (t) {
            ...
            if (e.interacting() && zt.check(e.interactable, e.prepared.name))
                if (e.simulation) zt.x = zt.y = 0;
                    ...
                    var r, o, a, s, l = e.interactable,
                        u = e.element,
                        c = e.prepared.name,
                        f = l.options[c].autoScroll,
                        d = Ct(f.container, l, u);
                    if (i.default.window(d)) s = n.clientX < zt.margin, r = n.clientY < zt.margin, o = n.clientX > d.innerWidth - zt.margin, a = n.clientY > d.innerHeight - zt.margin;
                    else {
    ...
    }), Le.default = Le.Interaction = Le._ProxyMethods = Le._ProxyValues = void 0, Le._ProxyValues = Be,
        function (t) {
            t.interactable = "", t.element = "", t.prepared = "", t.pointerIsDown = "", t.pointerWasMoved = "", t._proxy = ""
        }(Be || (Le._ProxyValues = Be = {})), Le._ProxyMethods = We,
        function (t) {
            ...
            function l(t, e, r, o) {
                ...
                if (u && u.events)
                    if ("all" !== e) {
                        ...
                        for (e in u.events) u.events.hasOwnProperty(e) && l(t, e, "all")
            }
